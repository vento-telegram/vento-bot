...
async def goto_referral(call: CallbackQuery, bot: Bot):
    ...
    text = (
        ...
        "👥 *Как это работает:*\n"
        "1. Поделись своей уникальной реферальной ссылкой с другом.\n"
        "2. Когда он перейдёт по ней и зарегистрируется — ты получаешь *+10 токенов* 💎\n"
        "3. Если твой друг купит любой пакет токенов — тебе прилетит ещё *+100 токенов* 🎉\n\n"
        "🔥 *Без ограничений!*\n"
